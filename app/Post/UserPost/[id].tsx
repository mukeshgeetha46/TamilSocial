...
import { useCommentSheet } from '@/app/context/CommentSheetContext';
import { useGetHomeFeedByidQuery } from '@/redux/api/feedApi';
...
export default function HomeScreen() {
    ...
    const { data, isFetching, isLoading, isError, refetch } = useGetHomeFeedByidQuery({ cursor, limit: 10, id });
